...
const ASTUR_PRODUCTS = {
  ...
  'FB-NMF': {
    ...
    gallery: [
      { src: '/assets/images/products/hangboards/forgeNomad/001.png', alt: 'Nomad Forge' },
      { src: '/assets/images/products/hangboards/forgeNomad/002.png', alt: 'Nomad Forge' },
      { src: '/assets/images/products/hangboards/forgeNomad/003.png', alt: 'Nomad Forge' },
      { src: '/assets/images/products/hangboards/forgeNomad/004.png', alt: 'Nomad Forge' },
      { src: '/assets/images/products/hangboards/forgeNomad/005.png', alt: 'Nomad Forge' },

...
const ASTUR_PRODUCTS = {
  'LC-D2010': {
    ...
    gallery: [
      ...
      { src: '/assets/images/products/Classic/Classic2010/2010-1.webp', alt: 'Classic Duo view 1' },
      { src: '/assets/images/products/Classic/Classic2010/2010-2.webp', alt: 'Classic Duo view 2' },
      { src: '/assets/images/products/Classic/Classic2010/2010-3.webp', alt: 'Classic Duo view 3' },
      { src: '/assets/images/products/Classic/Classic2010/2010-4.webp', alt: 'Classic Duo view 4' },
      { src: '/assets/images/products/Classic/Classic2010/2010-5.webp', alt: 'Classic Duo view 5' },
      { src: '/assets/images/products/Classic/Classic2010/Action.webp', alt: 'Classic Duo in use' },
      { src: '/assets/images/products/Classic/Classic2010/Front.webp', alt: 'Classic Duo front' },
  ...
  'LE-VDE': {
    ...
    gallery: [
      { src: '/assets/images/products/Ergo/VDE20/2020-1.webp', alt: 'Ergo VDE view 1' },
      { src: '/assets/images/products/Ergo/VDE20/2020-2.webp', alt: 'Ergo VDE view 2' },
      { src: '/assets/images/products/Ergo/VDE20/2020-3.webp', alt: 'Ergo VDE view 3' },
      { src: '/assets/images/products/Ergo/VDE20/2020-4.webp', alt: 'Ergo VDE view 4' },
      { src: '/assets/images/products/Ergo/VDE20/2020-5.webp', alt: 'Ergo VDE view 5' },
      { src: '/assets/images/products/Ergo/VDE20/Crag1Square.webp', alt: 'Ergo VDE at the crag' },
      { src: '/assets/images/products/Ergo/VDE20/IMG_3702.webp', alt: 'Ergo VDE detail' },
      { src: '/assets/images/products/Ergo/VDE20/ergoVDEDetail.webp', alt: 'Ergo VDE edge detail' },
      { src: '/assets/images/products/Ergo/VDE20/NoBack/ErgoVDE-001.webp', alt: 'Ergo VDE isolated view 1' },
      { src: '/assets/images/products/Ergo/VDE20/NoBack/ErgoVDE-002.webp', alt: 'Ergo VDE isolated view 2' },
    ],
  ...
  'LE-S20': {
    ...
    image: '/assets/images/products/Ergo/Stepped/_7OK4902_square.webp',
    price: '[PRICE]',
    category: 'Lifting Block — Ergo',
    filterTags: ['lifting-blocks', 'ergo'],
    description: [
    ...
    gallery: [
      { src: '/assets/images/products/Ergo/Stepped/_7OK4902_square.webp', alt: 'Ergo Step view 1' },
      { src: '/assets/images/products/Ergo/Stepped/_7OK4903_square.webp', alt: 'Ergo Step view 2' },
      { src: '/assets/images/products/Ergo/Stepped/_7OK4905_square.webp', alt: 'Ergo Step view 3' },
      { src: '/assets/images/products/Ergo/Stepped/NoBack/ErgoSteppedBlack-001.webp', alt: 'Ergo Step detail 1' },
      { src: '/assets/images/products/Ergo/Stepped/NoBack/ErgoSteppedBlack-002.webp', alt: 'Ergo Step detail 2' },
      { src: '/assets/images/products/Ergo/Stepped/NoBack/ErgoSteppedBlack-003.webp', alt: 'Ergo Step detail 3' },
      { src: '/assets/images/products/Ergo/Stepped/NoBack/ErgoSteppedBlack-004.webp', alt: 'Ergo Step detail 4' },
      { src: '/assets/images/products/Ergo/Stepped/NoBack/ErgoSteppedBlack-005.webp', alt: 'Ergo Step detail 5' },
      { src: '/assets/images/products/Ergo/Stepped/NoBack/ErgoSteppedBlack-006.webp', alt: 'Ergo Step detail 6' },
    ],
  ...
  'LE-O20': {
    ...
    image: '/assets/images/products/Ergo/Offset/Black/_7OK4884_square.webp',
    price: '[PRICE]',
    category: 'Lifting Block — Ergo',
    filterTags: ['lifting-blocks', 'ergo'],
    description: [
    ...
    gallery: [
      { src: '/assets/images/products/Ergo/Offset/Black/_7OK4882_square.webp', alt: 'Ergo Offset black view 1' },
      { src: '/assets/images/products/Ergo/Offset/Black/_7OK4883_square.webp', alt: 'Ergo Offset black view 2' },
      { src: '/assets/images/products/Ergo/Offset/Black/_7OK4884_square.webp', alt: 'Ergo Offset black view 3' },
      { src: '/assets/images/products/Ergo/Offset/Black/_7OK4885_square.webp', alt: 'Ergo Offset black view 4' },
      { src: '/assets/images/products/Ergo/Offset/Black/_7OK4886_square.webp', alt: 'Ergo Offset black view 5' },
      { src: '/assets/images/products/Ergo/Offset/Black/_7OK4888_square.webp', alt: 'Ergo Offset black view 6' },
      ...
      { src: '/assets/images/products/Ergo/Offset/Black/NoBack/ErgoOffsetBlack-001.webp', alt: 'Ergo Offset black detail' },
  ...
  'AC-SPL': {
    ...
    gallery: [
      ...
      { src: '/assets/images/products/PSS/Untitled-1.webp', alt: 'Pulley Splints detail 1' },
      { src: '/assets/images/products/PSS/Untitled-2.webp', alt: 'Pulley Splints detail 2' },
      { src: '/assets/images/products/PSS/Untitled-3.webp', alt: 'Pulley Splints detail 3' },
      { src: '/assets/images/products/PSS/Untitled-4.webp', alt: 'Pulley Splints detail 4' },

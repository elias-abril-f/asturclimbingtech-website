...
const ASTUR_PRODUCTS = {
  ...
  'FB-NMC': {
    ...
    features: [
      ...
      { title: 'Ultralight performance', text: '225g (carbon connector) or 255g (aluminium). Lighter than traditional hangboards without sacrificing feel' },
